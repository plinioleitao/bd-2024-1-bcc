...
2. **Na sua conta do GitHub**, criar um repositório necessariamente '**público**' de nome **bd-2023-2-bcc**:
   ...
   - então, a URL do repositório será https://github.com/contagithub/bd-2023-2-bcc, onde _**contagithub**_ é conta do aluno no GitHub (por exemplo, a conta do professor no GitHub é _**plinioleitao**_).
